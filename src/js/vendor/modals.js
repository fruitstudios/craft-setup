...
(function (root, factory) {
    ...
    var defaults = {
        ...
        selectorIgnore: '[data-modal-ignore]',
     ...
     * @private
     */
    var createModalBg = function (options) {
        ...
        parent.replaceChild(modalBg, modal);
        // set element as child of wrapper
        modalBg.appendChild(modal);


        // Append the modal with background to the page
        document.body.appendChild(modalBg);

    };

    /**
     * Split the modal out of the background
     * @private
     */
    // https://stackoverflow.com/questions/19261197/how-can-i-remove-wrapper-parent-element-without-removing-the-child
    var unwrapModal = function (wrapper) {
    ...
    var eventHandler = function (event) {
        ...
        if(getClosest(toggle, settings.selectorIgnore)) return;
